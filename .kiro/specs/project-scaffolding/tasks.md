...
- [ ] 2. Implement entry points
  - [ ] 2.1 Create Server entry point at cmd/server/main.go
  ...
  - [ ] 2.2 Create Runner entry point at cmd/runner/main.go
...
- [ ] 3. Checkpoint - Verify module and entry points
...
- [ ] 4. Set up Protobuf with buf
  - [ ] 4.1 Create proto directory structure and buf configuration
  ...
  - [ ] 4.2 Generate Go code from proto definitions
...
- [ ] 5. Create Makefile
  - [ ] 5.1 Create Makefile with all required targets
...
- [ ] 6. Configure linting
  - [ ] 6.1 Create .golangci.yml configuration
...
- [ ] 8. Create Dockerfiles
  - [ ] 8.1 Create Server Dockerfile at build/server/Dockerfile
  ...
  - [ ] 8.2 Create Runner Dockerfile at build/runner/Dockerfile
...
- [ ] 9. Configure CI and Dependabot
  ...
  - [ ] 9.2 Create Dependabot configuration
